...
DROP TABLE IF EXISTS ENVIOVITAL.EVENTOALMACENCONDUCTOR CASCADE;
DROP TABLE IF EXISTS ENVIOVITAL.EVENTOALMACEN CASCADE;
DROP TABLE IF EXISTS ENVIOVITAL.VEHICULO CASCADE;
DROP TABLE IF EXISTS ENVIOVITAL.EVENTO CASCADE;
DROP TABLE IF EXISTS ENVIOVITAL.ALMACEN CASCADE;
DROP TABLE IF EXISTS ENVIOVITAL.CONDUCTOR CASCADE;
DROP TABLE IF EXISTS ENVIOVITAL.TIPOVEHICULO CASCADE;
DROP TABLE IF EXISTS ENVIOVITAL.USUARIO CASCADE;
DROP TABLE IF EXISTS ENVIOVITAL.PROVINCIA CASCADE;
...
alter table enviovital.conductor add column foto_url varchar (255);
...
INSERT INTO ENVIOVITAL.CONDUCTOR (nombre, apellidos, dni, direccion, telefono, id_usuario, fecha_nacimiento, email, foto_url)
VALUES
    ('Antonio', 'García López', '12345678A', 'Calle Gran Vía, Madrid', '612345678', 2, '1980-05-15', 'antonio.garcia@example.es', null),
    ('María', 'Martínez Sánchez', '12345679B', 'Calle Alcalá, Madrid', '622345678', 3, '1985-08-22', 'maria.martinez@example.es', null),
    ('Carlos', 'Rodríguez Gómez', '12345680C', 'Avenida Diagonal, Barcelona', '632345678', 4, '1990-01-30', 'carlos.rodriguez@example.es', null),
    ('Laura', 'Hernández Ruiz', '12345681D', 'Calle Serrano, Madrid', '642345678', 5, '1987-03-12', 'laura.hernandez@example.es', null),
    ('Pedro', 'López Fernández', '12345682E', 'Paseo de Gracia, Barcelona', '652345678', 6, '1982-11-25', 'pedro.lopez@example.es', null),
    ('Alba', 'Vidal Galan', '12345000E', 'Paseo de Gracia, Barcelona', '652345608', 7, '1980-11-25', 'ala.lz@example.com', null),
    ('Antonio', 'Perez Garcia', '10045000E', 'Paseo de Gracia, Barcelona', '600345608', 8, '1988-12-22', 'anala.lyz@example.com', null),
    ('Luis', 'Ferraz Lope', '47340693Y', 'Cañada Real, Lebrija', '722443099', 9, '1995-11-11', 'payasa@live.com', null),
    ('Pablo', 'Pedroso Perez', '47340690I', 'Calle Gol, Sevilla', '722443000', 10, '1990-01-01', 'pedroso@live.com', null),
    ('Alberto', 'Gordez Pino', '46320994H', ' Calle Calatrava, 89', '722443770', 11, '1991-09-09', 'pineo@live.com', null);
